...
! Model Parameters
	...
	! sdim = Number of parameters in the model fit
      	INTEGER, PARAMETER :: sdim = 17
      	INTEGER, PARAMETER :: OOTlen = 12
      	INTEGER, PARAMETER :: taulen = 0
      	INTEGER, PARAMETER :: Vsyslen = 0
      	INTEGER, PARAMETER :: nparamorig = 17

        ! seriesP.dat controls
      	INTEGER, PARAMETER :: nplen = 1807
        ...
        ! TESS
				INTEGER, PARAMETER :: nslen = 3571
        INTEGER, PARAMETER :: NresamS = 5
        REAL(8), PARAMETER :: integ_bigS = 0.00694444D0 ! 60 seconds
				
				! BARON
				INTEGER, PARAMETER :: nqlen = 96 
        INTEGER, PARAMETER :: NresamQ = 5
        REAL(8), PARAMETER :: integ_bigQ = 0.001805572996090632D0 ! 156 seconds

				! LCO
				INTEGER, PARAMETER :: ntlen = 146
        INTEGER, PARAMETER :: NresamT = 5
        REAL(8), PARAMETER :: integ_bigT = 0.0006018518518518519D0 ! 52 seconds
				
				! Whitin
				INTEGER, PARAMETER :: nulen = 455
        INTEGER, PARAMETER :: NresamU = 5
        REAL(8), PARAMETER :: integ_bigU = 0.0003472222222222222D0 ! 30 seconds

        ! seriesR.dat controls
      	INTEGER, PARAMETER :: nrlen = 16
...
! Model Variables
        ...
        REAL(8), DIMENSION(nplen) :: fpmod
				...
				! TESS
        REAL(8), DIMENSION(nslen) :: ts, fs, sigfs
        REAL(8), DIMENSION(nslen) :: fswei, sigfswei, logsigfs, tsdeviant
        INTEGER, DIMENSION(nslen) :: epochs_seq
        REAL(8), DIMENSION(nslen) :: fsmod
				
				! BARON
        REAL(8), DIMENSION(nqlen) :: tq, fq, sigfq
        REAL(8), DIMENSION(nqlen) :: fqwei, sigfqwei, logsigfq, tqdeviant
        INTEGER, DIMENSION(nqlen) :: epochq_seq
        REAL(8), DIMENSION(nqlen) :: fqmod
				
				! LCO
        REAL(8), DIMENSION(ntlen) :: tt, ft, sigft
        REAL(8), DIMENSION(ntlen) :: ftwei, sigftwei, logsigft, ttdeviant
        INTEGER, DIMENSION(ntlen) :: epocht_seq
        REAL(8), DIMENSION(ntlen) :: ftmod
				
				! Whitin
        REAL(8), DIMENSION(nulen) :: tu, fu, sigfu
        REAL(8), DIMENSION(nulen) :: fuwei, sigfuwei, logsigfu, tudeviant
        INTEGER, DIMENSION(nulen) :: epochu_seq
        REAL(8), DIMENSION(nulen) :: fumod
...
! Parameters for Nested Sampler
	...
	parameter(nest_root='chains/LRVmoon-')
